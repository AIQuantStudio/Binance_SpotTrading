...
class TestTradeSettingPanel(QFrame, TradeSettingInterface):
    ...
    def get_setting_data(self) -> Any:
        ...
        test_setting_data = TestSettingStruct(predict_at_first_time=predict_at_first_time, begin_datetime=begin_datetime, end_datetime=end_datetime, refer_currency=refer_currency, trade_amount=trade_amount)
