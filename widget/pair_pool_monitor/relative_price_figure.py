...
class RelativePriceFigure(FigureCanvasQTAgg):
    ...
    def __init__(self, width=12, height=8, dpi=100):
        ...
        self.fig = Figure(figsize=(width, height), dpi=dpi, facecolor="#19232d", edgecolor="white")

        self.axes = self.fig.add_subplot(111)
        self.axes.set_facecolor("#1d2934")
        self.axes.set_xlabel("Time", color="w")
        self.axes.set_ylabel("Price", color="w")
        self.axes.tick_params(axis="both", color="w", labelcolor="w")
